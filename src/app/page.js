        ...
        <section className="mx-auto w-full max-w-4xl rounded-2xl border border-gray-200 bg-white p-6 sm:p-8 shadow-lg dark:border-gray-800 dark:bg-[#1E1E1E] print:space-y-6">
          ...
          <div className="flex flex-col-reverse items-start justify-between gap-6 sm:gap-8 md:flex-row md:items-center">
            <div className="flex-1 space-y-4">
              <div className="flex items-center justify-between gap-4">
                <h1 className="bg-gradient-to-r from-gray-900 to-gray-600 bg-clip-text text-2xl sm:text-3xl font-bold text-transparent dark:from-white dark:to-gray-400">
                  {RESUME_DATA.name}
                </h1>
                <ThemeSwitch />
              </div>
              <p className="max-w-md text-xs sm:text-sm md:text-base font-mono text-gray-700 dark:text-[#B8B8B8]">
                {RESUME_DATA.about}
              </p>
          ...
          <div className="mt-6 sm:mt-8 grid gap-6 sm:gap-8">
            <Section>
              ...
              <p className="text-xs sm:text-sm md:text-base text-pretty font-mono text-gray-600 dark:text-[#B8B8B8]">
                {RESUME_DATA.summary}
              </p>
            </Section>
            ...
            <Section>
              ...
              <div className="flex flex-wrap gap-2">
                {RESUME_DATA.skills.map((skill) => (
                  <Badge
                    key={skill}
                    className="bg-gray-100 text-xs sm:text-sm text-gray-700 dark:bg-gray-800 dark:text-gray-300"
                  >
                    {skill}
                  </Badge>
                ))}
