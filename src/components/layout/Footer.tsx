    ...
    return (
        <footer id="footer" className="bg-surface mt-6 sm:mt-8 md:mt-12 lg:mt-16 relative z-footer overflow-hidden w-full font-mono">
            <div className="w-full py-6 sm:py-8 md:py-10 lg:py-12 relative z-10">
                ...
                {/* Social Media — left on desktop, center on mobile */}
                <div className="mt-6 sm:mt-8 w-full flex flex-row items-center justify-center md:justify-start gap-6 sm:gap-4 px-4 sm:px-6 md:px-8 lg:px-16">
                    {renderSocialLinks(
                        socialLinks,
